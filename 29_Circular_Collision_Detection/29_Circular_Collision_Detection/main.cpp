...
void Dot::move(SDL_Rect &square, Circle &circle)
{
	...
	if ((m_PosX - m_Collider.r < 0) || (m_PosX + m_Collider.r > SCREEN_WIDTH) || CheckCollision(m_Collider, square) || CheckCollision(m_Collider, circle))
	{
		// Move back
		m_PosX -= m_VelX;
		shiftColliders();
	...
	// IF the dot went too far to the left or the right or the dot collided
	if ((m_PosY - m_Collider.r < 0) || (m_PosY + m_Collider.r > SCREEN_HEIGHT) || CheckCollision(m_Collider, square) || CheckCollision(m_Collider, circle))
	{
		// Move back
		m_PosY -= m_VelY;
		shiftColliders();
...
{
	// Show the dot
	gDotTexture.render(m_PosX - m_Collider.r, m_PosY - m_Collider.r);
}
